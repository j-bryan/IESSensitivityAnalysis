...
def modifyInput(root,mod_dict):
  ...
  if mc is not None:
    ...
    for comp in comps:
      capacities[comp] = mod_dict['Samplers|MonteCarlo@name:mc_arma_dispatch|constant@name:{}_capacity'.format(comp)]  # TODO: need to vary any sampled Parametric ValuedParam, not just capacities
