...
def grid_price(data, meta):
    ...
    # }
    data = {
        'component': ['Nuclear', 'NGCC', 'NGGT', 'Overflow'],
        'marginal_cost': [12.689066, 25.109150, 32.703513, 169.679554],  # TODO: keeping these the same since idk what to change them to
        'capacity_gw': [25.407, 50, 50, 60]  # TODO: I made these up for testing purposes
    }
